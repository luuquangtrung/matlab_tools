function varargout = osFuncDiagram(foo, varargin)

% Adopted from https://www.mathworks.com/matlabcentral/fileexchange/46080-plot_depfun
% osFuncDiagram(foo, varargin): plots a tree of the dependencies of function foo
% Ex: osFuncDiagram('C:\Users\qluu\Downloads\Dropbox\Trung\3_Workspace\cplex_matlab\carp\CARP_MAIN.m')
...
while any(~done)
    for i=find(~done)
        if verLessThan('matlab','8.3')
            ...
            keep = cellfun('isempty',strfind(new,matlabroot)); %#ok<STRCL1>
        else
